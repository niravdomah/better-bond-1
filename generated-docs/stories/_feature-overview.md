...
1. **Epic 1: Dashboard** - At-a-glance commission payment metrics and agency summary grid with dynamic chart filtering by selected agency | Status: Pending | Dir: `epic-1-dashboard/`
