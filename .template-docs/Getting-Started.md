...
### First-Time Setup (Required for Private Templates)

Since the upstream template repository is private, authentication is required for syncing.

**For repositories in the `stadium-software` organization:**
No setup required - organization secrets are automatically available.

**For external repositories:**
Contact Stadium Software for credentials, then follow the [Template Sync Setup Guide](./Help/Template-Sync.md).
