...
2. **SCOPE** - Break your spec into epics
3. **STORIES** - Define stories for each epic
4. **WRITE-TESTS** - Generate test cases for each story
5. **IMPLEMENT** - Write the code to pass those tests
6. **QA** - Review code, run quality gates, and commit
